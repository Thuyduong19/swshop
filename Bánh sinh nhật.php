        ...
        <div class="catergory">
            ...
            <div class="products-right">
                <div class="products-right-top">
                    <center><h1>Bánh sinh nhật</h1></center><br>
                </div>
                <div class="products-right-content row">
                    <div class="products-right-content-item">
                        ...
                        <h1><a href="Product.php">Bánh pastry Orient Scent</a></h1>
                        <p>595.000<sup>đ</sup></p>
                    </div>
                    <div class="products-right-content-item">
                        <img src="ảnh/15. Pastry Roll in Love.png" alt="Pastry Roll in Love">
                        <h1><a href="#">Pastry Roll in Love</a></h1>
                        <p>435.000<sup>đ</sup></p>
                    </div>
                    <div class="products-right-content-item">
                        <img src="ảnh/17. Bánh Pastry Secret Garden.png" alt="Bánh Pastry Secret Garden">
                        <h1><a href="#">Bánh Pastry Secret Garden</a></h1>
