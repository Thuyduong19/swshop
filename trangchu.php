...
<html lang="vi">
  ...
  <body>
    ...
    <main class="main">
      <div class="banner">
        <a href="boloc.php"><img src="anh1.png" alt="Vanilla Cheese Cake" /></a>
    </div>
    <div class="mess"> 
      <a href="http://m.me/268589776344345"><img tytle="chat" src="messenger.png"width="40px" heigh="40px"></a>
    </div>
    <?php
    ...
    if ($search) {
        ...
        $products = mysqli_query($con, "SELECT * FROM `product` ORDER BY `id` ASC LIMIT 4");
