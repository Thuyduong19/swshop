    ...
    <section class="product">
        <div class="Tatcasp">
            <div class="product-top row">
                <p>Trang chủ</p> <span>&#8260; </span> <p>Bánh sinh nhật</p> <span>&#8260;</span> <p>Bánh Orient Scent</p> 
            </div>
            <div class="product-content row">
                <div class="product-content-left">
                    <div class="product-content-left-img">
                    <img src="ảnh/12. Bánh pastry Orient Scent.png" alt=""> </div>
                </div>
                <div class="product-content-right" >
                    <div class="product-content-right-product-name">
                        <h1> <b> Bánh Orient Scent </b></h1>
                        <p>Xoài tươi, Lá dứa & Phô mai</p>
                    </div>
                    <div class="product-content-right-product-price">
                        <p3>595,000<sup>đ</sup></p3>
                        <p4>490.000<sup>đ</sup></p4>
                    </div>
                    <div class="quantity">
